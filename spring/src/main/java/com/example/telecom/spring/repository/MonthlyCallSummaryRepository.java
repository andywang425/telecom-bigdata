...
import com.example.telecom.spring.model.entity.MonthlyCallSummaryId;
...
public interface MonthlyCallSummaryRepository extends JpaRepository<MonthlyCallSummary, MonthlyCallSummaryId> {
